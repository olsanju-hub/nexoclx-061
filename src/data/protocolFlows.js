...
export const protocolFlows = [
  ...
  },
  {
    ...
    category: 'Trauma',
    summary: 'XABCDE traumático, hemorragia, shock, hospital útil y traslado crítico.',
    ...
    tabs: {
      ...
      Valoración: [
        'XABCDE traumático: X es hemorragia catastrófica/exanguinante y se controla antes de A.',
        'A con vía aérea y control cervical; B ventilación/tórax; C circulación, shock y hemorragia no catastrófica; D GCS, pupilas y glucemia si conciencia alterada; E exposición y prevención de hipotermia.',
      ...
      Decisión: [
        ...
        'Prealertar con mecanismo, XABCDE, constantes, GCS, sospecha de lesiones, tratamientos, respuesta, anticoagulación y ETA.',
      ],
      Tratamiento: [
        ...
        'Cristaloide isotónico solo si hipoperfusión traumática compatible; si sangrado activo no controlado, usar estrategia restrictiva según protocolo y no normalizar TA de forma agresiva.',
        'Si TCE grave domina el cuadro, evitar hipotensión y seguir objetivo hemodinámico del protocolo local/centro coordinador.',
      ...
      Traslado: [
        ...
        'Si empeora: reevaluar XABCDE, tratar amenaza inmediata, actualizar prealerta y revisar destino.',
      ],
    },
  },
  {
