export const protocols = [
  {
    ...
    internalNotes: 'Criterios ECG y doble antiagregación deben alinearse con código infarto local antes de ampliar dosis.',
    bibliography: ['esc-acs-2023', 'cima-aas', 'cima-nitroglicerina'],
    verificationStatus: 'Dosis de nitroglicerina verificada; antiagregación marcada pendiente de protocolo local.',
  },
  {
    id: 'ictus-agudo',
